...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Dec 26 11:37:21 2014
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/main1.0.0/ && $(COPY_FILE) --parents mainwindow.h mainview.h picview.h uirectangle.h uielement.h uicoordinate.h uicurve.h .tmp/main1.0.0/ && $(COPY_FILE) --parents mainwindow.cpp mainview.cpp picview.cpp uirectangle.cpp uielement.cpp main.cpp uicoordinate.cpp uicurve.cpp .tmp/main1.0.0/ && (cd `dirname .tmp/main1.0.0` && $(TAR) main1.0.0.tar main1.0.0 && $(COMPRESS) main1.0.0.tar) && $(MOVE) `dirname .tmp/main1.0.0`/main1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/main1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_mainview.cpp moc_picview.cpp moc_uirectangle.cpp moc_uielement.cpp moc_uicoordinate.cpp moc_uicurve.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_mainview.cpp moc_picview.cpp moc_uirectangle.cpp moc_uielement.cpp moc_uicoordinate.cpp moc_uicurve.cpp
